...
export default function AddBirdScreen({ navigation }) {
  ...
  const getCurrentLocation = async () => {
    try {
      ...
      // Geocodificação reversa para obter cidade e país
      ...
      if (addresses && addresses.length > 0) {
        ...
        // Tenta obter a cidade em diferentes campos do endereço
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        alert('Erro ao registrar o pássaro');
      }
    } catch (error) {
